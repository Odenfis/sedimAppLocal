...
function validateMigration(source, file) {
    ...
    for (const match of writes) {
        ...
        if (!['pedido_control','pedido_lineas','cocina_envios','cocina_envio_detalles','cocina_estados','impresion_trabajos','impresion_linea_rutas','impresion_barra_trabajos','cocina_pedidos_legacy','cocina_pedidos','cierres_turno','cierre_turno_archivos','cierre_turno_operaciones','web_sessions','migrations'].includes(table)) {
