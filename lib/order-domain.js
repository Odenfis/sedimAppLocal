...
const QUICK_NOTES = ['Sin cebolla', 'Término medio', 'Bien cocido', 'Poco picante', 'Sin picante', 'Hielo aparte', 'Sin azúcar', 'Para llevar', 'Servir primero', 'Con salsa aparte'];
...
function printText(envio, movements, reprint = false) {
    ...
    const lines = [wrap(envio.empresaNombre || `Empresa ${envio.empresa}`), 'COMANDA DE COCINA', reprint ? '*** REIMPRESIÓN ***' : '',
